...
This project is powered by [The Solar System OpenData API](https://api.le-systeme-solaire.net/). It retrieves the `rest/bodies/` endpoint to populate the dropdown and data cards dynamically.
